...
The Perennial Sorority is a highly technologically advanced civilization, surpassed by few others in the galaxy. There are several notable technologies that will likely appear in the story that should be talked about.
### Memory archiving
Unmodified organic brains are unable to retain many memories past a few hundred years. To aid in memory recall over deep time, the Perennians utilize a complex embedded neural implant that cascades from their hippocampus out to the rest of the brain in order to create a permanent document of long term memories which are then stored within their Index and Almanac.
### Cloning
Accessing memory archives is extremely difficult, the brain is extremely complex and there are thousands if not millions of variables involved in memory recovery. In order to aid in the recovery of memories with minimal degradation, all custodians of a particular Almanac share the same fundamental genetic code and are manipulated within the gestation chamber to share a nearly identical neural structure to their foremother.
### Space-time Manipulation
Though the technology is extremely sophisticated, being fully understood by only a handful of Perennians. Their people possess the technology to manipulate the warping of space-time to allow for a variety of technologies that have become fairly common.
#### Tensor-drive
Though faster-than-light travel is impossible, space-time manipulation allows for acceleration at speeds of up to 10,000 m/s/s, pushing ships to maximum velocities as high as .999c before drag from interstellar particulates cancel out any further acceleration. The Tensor-drive can also be used to create artificial gravity.
While the Tensor-drive does manipulate space-time like a warp drive, it does not facilitate faster-than-light travel as the speed of the Tensor-drive is limited by the speed that sufficient energy can move through the field. Since the energy is limited by the speed of light, no amount of energy could allow the Tensor-drive to exceed that speed.
#### Abeyance
Temporal Tensor-contraction, more commonly referred to as Abeyance. With clever engineering a time manipulation pod can be constructed allowing for the slowing of time to as much as 1/1,000,000 the normal flow of space-time allowing the occupant to experience mere hours while centuries have passed in the outside world. This combined with time perception altering drugs or sedation can allow an occupant to survive for thousands of years while have perceiving virtually no time passing at all. Though the technology is expensive to operate and thus rarely used at scale.
#### Whisking
Tensor Lanes, more commonly referred to as "Whisking", is a form of high speed transportation, that appear as pillars of light. An object is placed within a small tensor bubble and fired along a guiding beam to a receiving terminal where the energy is safely dissipated. This allows for the transportation of people or objects at velocities of up to .02c. Extremely weak bubbles fired at low velocities, several times the speed of sound, can safely dissipate upon impact with an object allowing for short distance transport without a receiving terminal.
Whisking is very energy intensive and so is usually reserved for the transportation of sensitive or valuable cargo, such as living organisms or delicate technology.